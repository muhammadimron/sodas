        ...
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                ...
                <p class="mb-6 text-gray-500">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam quod consequatur libero magni! Illo nulla quae animi explicabo iusto. Rem blanditiis earum, omnis quos sit harum. Veniam accusamus mollitia a?
                </p>
                <p class="font-bold">
                    Already have an account? <a href="#" class="underline">Click here</a> to create one!
                </p>
            </div>
        </div>
        <div class="main-right">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6">
                    <div>
                        <label>Name</label><br>
                        <input type="text" placeholder="Your fullname" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                    </div>
                    <div>
