    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                <img src="https://i.pravatar.cc/300?img=70" alt="avatar" class="mb-6 rounded-full">
                <p><strong>Master Stark</strong></p>
        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <img src="https://images.unsplash.com/photo-1661956602868-6ae368943878?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2670&amp;q=80" alt="avatar" class="w-full rounded-lg">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi quod nostrum obcaecati dolore doloribus quas in a ad vitae! Soluta esse nulla impedit porro repellendus eveniet distinctio assumenda rem ipsa!</p>
                <div class="my-6 flex justify-between">
                    <div class="flex space-x-6">
                        <div class="flex items-center space-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="main-right col-span-1 space-y-4">
            ...
            <p-4 class="bg-white border border-gray-200 rounded-lg">
                <h3 class= "mb-6 text-xl">Trends</h3>
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <p class="text-xs">
                                <strong>#masterstark</strong><br>
