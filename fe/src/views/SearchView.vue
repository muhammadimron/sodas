            ...
            <div class="bg-white border border-gray-200 rounded-lg">
                <form @submit.prevent="handleSearch()">
                    <div class="p-4 flex space-x-4">  
                        ...
                        <button type="submit" class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg">Search</button>
                    </div>
                </form>
            </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-4 gap-4">
                <template v-for="user in users" :key="user.email">
                    <div class="p-4 text-center bg-gray-100 rounded-lg">
                        <img src="https://i.pravatar.cc/300?img=70" class="mb-6 rounded-full" alt="avatar">
                ...
                <div class="p-4 bg-white border border-gray-200 rounded-lg">
                    <div class="mb-6 flex items-center justify-between">
                        <div class="flex items-center space-x-6">
                            ...
                            <RouterLink :to="{ name: 'profile', params: { id: post.user.id } }">
